...
- Property context may be provided (e.g. build era). Homes built pre-1990 may contain asbestos: treat work disturbing walls, ceilings or eaves in them conservatively — never DIY, and flag asbestos when materials would be disturbed. Property context can only raise risk, never lower it.
