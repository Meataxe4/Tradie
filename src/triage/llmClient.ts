...
export class MockTriageClient implements TriageLlmClient {
  ...
  private build(input: TriageInput): ModelTriage {
    ...
    if (has("burst pipe", "leaking pipe", "pipe leak", "ceiling leak", "leaking through the ceiling", "leak in the ceiling", "water stain on the ceiling", "tap replace", "mixer", "cistern", "hot water system", "no hot water", "blocked drain machine", "water leak", "water leaking", "leak under", "leaking under", "sink is leaking", "leaking sink", "water under the sink", "damp", "moisture", "water damage", "water stain", "wet patch", "water is coming", "water coming in", "pouring in")) {
      return needsPro({
